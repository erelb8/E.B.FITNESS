-- =====================================================================
--  E.B FIT — כל מה שחסר בשרת, בהרצה אחת
--  ---------------------------------------------------------------
--  Supabase -> SQL Editor -> New query -> הדבק הכל -> Run
--  בטוח להרצה חוזרת: אפשר להריץ שוב ושוב בלי נזק.
--
--  מה זה מתקן:
--   * עמודת meals   — בלעדיה התפריטים לא מגיעים למתאמן
--   * trainee_login — בלעדיה כניסה עם שם משתמש וסיסמה לא עובדת
--   * trainee_program — מרחיב אותה כך שתחזיר גם קבצים, יעדים וארוחות
-- =====================================================================
