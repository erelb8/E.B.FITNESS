...
--
-- מוחקים לפני היצירה: הפונקציה כבר קיימת מ-login.sql, וכאן נוספת לה
-- עמודת meals. פוסטגרס לא מרשה ל-create or replace לשנות את טיפוס
-- ההחזרה של פונקציה קיימת — רק מחיקה ויצירה מחדש.
-- ---------------------------------------------------------------------
