...
const SHELL_FILES = [
  ...
  './files.js?v=v119',
  './builder.js?v=v119',
  './import-program.js?v=v119',
  './tracking.js?v=v119',
  './metrics.js?v=v119',
  './targets.js?v=v119',
  './meals.js?v=v119',
  './meal-library.js?v=v119',
  './progress.js?v=v119',
  './habits.js?v=v119',
  './coach-bot.js?v=v119',
  './workout-log.js?v=v119',
  './library-ui.js?v=v119',
  './export-plan.js?v=v119',
  './cardio.js?v=v119',
  './cardio-ui.js?v=v119',
  './exercise-library.js?v=v119',
  './exercise-ui.js?v=v119',
  './vendor/supabase.js?v=v119',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-256.png',
  './icons/icon-512.png',
