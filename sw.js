...
const SHELL_FILES = [
  ...
  './files.js?v=v127',
  './builder.js?v=v127',
  './import-program.js?v=v127',
  './tracking.js?v=v127',
  './metrics.js?v=v127',
  './targets.js?v=v127',
  './meals.js?v=v127',
  './meal-library.js?v=v127',
  './progress.js?v=v127',
  './habits.js?v=v127',
  './coach-bot.js?v=v127',
  './workout-log.js?v=v127',
  './library-ui.js?v=v127',
  './export-plan.js?v=v127',
  './cardio.js?v=v127',
  './cardio-ui.js?v=v127',
  './exercise-library.js?v=v127',
  './exercise-ui.js?v=v127',
  './vendor/supabase.js?v=v127',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-256.png',
  './icons/icon-512.png',
