...
const SHELL_FILES = [
  ...
  './files.js?v=v100',
  './builder.js?v=v100',
  './import-program.js?v=v100',
  './tracking.js?v=v100',
  './metrics.js?v=v100',
  './meals.js?v=v100',
  './meal-library.js?v=v100',
  './progress.js?v=v100',
  './coach-bot.js?v=v100',
  './library-ui.js?v=v100',
  './export-plan.js?v=v100',
  './cardio.js?v=v100',
  './cardio-ui.js?v=v100',
  './exercise-library.js?v=v100',
  './exercise-ui.js?v=v100',
  './vendor/supabase.js?v=v100',
  './icons/icon-180.png',
  './icons/icon-192.png',
  './icons/icon-256.png',
  './icons/icon-512.png',
