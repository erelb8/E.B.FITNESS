...
(function () {
  ...
  (window.EB_MOD = window.EB_MOD || {})['exportPlan'] = 'v44';
...
+ '<link href="https://fonts.googleapis.com/css2?family=Heebo:wght@300;400;500;700&family=Rubik:wght@500;700;900&display=swap" rel="stylesheet">'
+ '<style>'
+ ':root{--ink:#0D0D0F;--panel:#151519;--panel-2:#1C1C22;--line:#2A2A32;--line-2:#3A3A46;'
+ '--text:#F3F1EE;--muted:#94949E;--dim:#5F5F6B;--flame:#FF6A00;--ember:#FFA24D;--ok:#4ADE80;--r:14px}'
+ '*{box-sizing:border-box}html,body{margin:0;padding:0}'
+ 'body{background:var(--ink);color:var(--text);font-family:Heebo,system-ui,sans-serif;font-size:15px;line-height:1.5;'
+ '-webkit-font-smoothing:antialiased;background-image:radial-gradient(900px 460px at 88% -8%,rgba(255,106,0,.13),transparent 62%);'
+ 'background-attachment:fixed;padding-bottom:calc(48px + env(safe-area-inset-bottom))}'
+ 'h1,h2,h3{font-family:Rubik,sans-serif;margin:0;font-weight:700;letter-spacing:-.02em}'
...
+ 'border:1px solid rgba(255,106,0,.16);border-radius:50%}'
+ 'header::before{content:"";position:absolute;left:-30px;top:-60px;width:170px;height:170px;'
+ 'border:1px solid rgba(255,106,0,.10);border-radius:50%}'
+ '.badge{display:inline-block;font-family:Rubik;font-weight:700;font-size:11px;letter-spacing:.14em;'
+ 'color:var(--flame);background:rgba(255,106,0,.10);border:1px solid rgba(255,106,0,.30);padding:5px 12px;border-radius:20px}'
...
+ '.pill b{color:var(--text);font-family:Rubik;font-weight:700}'
...
+ '.gauge .g-num{position:absolute;inset:0;display:grid;place-items:center;font-family:Rubik;font-weight:900;font-size:19px}'
+ '.prog-info{flex:1;min-width:0}.prog-info .t{font-family:Rubik;font-weight:700;font-size:15px}'
...
+ '.ring i{position:absolute;inset:0;display:grid;place-items:center;font-style:normal;font-family:Rubik;font-weight:900;font-size:14px;color:var(--muted)}'
+ '.day.done .ring i{color:var(--ok)}'
+ '.day-t{flex:1;min-width:0}'
+ '.day-name{display:block;font-family:Rubik;font-weight:700;font-size:15.5px;line-height:1.3}'
...
+ 'border-left:2px solid #08120B;border-bottom:2px solid #08120B;transform:rotate(-45deg) translate(1px,-2px);opacity:0}'
...
+ '.spec{font-family:Rubik;font-weight:700;font-size:13px;background:var(--panel-2);border:1px solid var(--line);'
...
+ '.meal-b{padding:13px}'
+ '.meal-n{font-family:Rubik;font-weight:700;font-size:15.5px;line-height:1.3}'
...
+ '.tg.hot{background:rgba(255,106,0,.12);color:var(--flame);border-color:rgba(255,106,0,.3)}'
...
+ '<stop offset="0%" stop-color="#FF6A00"/><stop offset="100%" stop-color="#FFA24D"/>'
