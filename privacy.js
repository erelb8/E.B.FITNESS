...
(function () {
  ...
  (window.EB_MOD = window.EB_MOD || {})['privacy'] = 'v166';
  ...
  /* שינוי מהותי בנוסח מחייב מספר גרסה חדש: השער בדף המתאמן משווה
     את הגרסה שאושרה לזו שבתוקף, ולכן העלאת המספר מבקשת אישור מחדש.
     אישור על נוסח ישן אינו אישור על החדש. */
  var TERMS_VERSION = '3';
