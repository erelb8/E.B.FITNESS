...
(function () {
  ...
  (window.EB_MOD = window.EB_MOD || {})['bot'] = 'v175';
  ...
  /* ימים אמיתיים בתוכנית — לא ימים ריקים ולא ימי הנחיות. עד v175 כל
  ...
  function trends() {
    ...
    Object.keys(s).forEach(function (name) {
      ...
      out.push({
        ...
        /* שיא = טוב מכל אימון קודם. עד v175 גם חזרה על אותו משקל נקראה
  ...
  function neglectedDays() {
    ...
    LOGS.forEach(function (l) {
      ...
      /* בשרת השדה הוא day_name. עד v175 נקרא רק dayName, ולכן כל יום
  ...
  /* ---------- כאב ועייפות ----------
     ...
     מדבר על שיאים. עד v175 הבוט לא קרא את ההערות ואת ה"איך היה" בכלל.
  ...
  /* ---------- תזונה ----------
     עד v175 הבוט לא ראה מה המתאמן אוכל, ועל משקל שלא זז אמר רק "זה
